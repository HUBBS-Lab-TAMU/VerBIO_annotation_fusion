...
for seed_val in seed_list:
    for nm in label_list:
        command = f'python main.py --task stress --lr 0.0002 --rnn_n_layers 4 --epochs 200 --label_type {nm} --label_folder Mean --seed {seed_val} --use_gpu'
    ...
    for nm in label_list:
        command = f'python main.py --task stress --lr 0.0002 --rnn_n_layers 4 --epochs 200 --label_type {nm} --label_folder Selective --seed {seed_val} --use_gpu'
